...
export default async function ProjectPage({ params }) {
  ...
  const info = [
    ...
    "In this project I made the minesweeper game in Java. I've learned how to structure a project, code in Jave, use classes, grid logic, JavaFX, GUI, testing and more.",
