...
export default function Aboutme() {
    return (
        <div className="w-6/12 text-white bg-zinc-700 border-r-2 border-zinc-900 ml-2">
            ...
            <br />
            <div id="Aboutme" className="text-s ">Hello! I&apos;m
                David Zvonaruv, a Software Engineer. Let me tell you a bit about myself.
                <br /><br />
                ...
                <br /><br />
                My academic accomplishments reflect a commitment to excellence. Mastering concepts in Data Structures & Introduction to Algorithms, Elements of Computing Systems, and Operating Systems, I&apos;ve honed my proficiency in foundational areas that underscore a strong technical foundation. <br /> <br />
                ...
                <p id="Education" className="text-s ">
